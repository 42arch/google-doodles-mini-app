...
function clear() {
    ...
    const oldTarget = ( true)
        ? Object(_vue_shared__WEBPACK_IMPORTED_MODULE_0__[/* isMap */ "s"])(target)
            ? new Map(target)
            : new Set(target)
        : undefined;
    // forward the operation before queueing reactions
...
const deprecationData = {
    ...
    ["COMPONENT_V_MODEL" /* COMPONENT_V_MODEL */]: {
        message: (comp) => {
            ...
            if (comp.props &&
                (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isArray */ "n"])(comp.props)
            ...
            if (keys.length) {
                if (shapeFlag & 1 /* ELEMENT */ ||
                    ...
                    for (let i = 0, l = allAttrs.length; i < l; i++) {
                        ...
                        if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isOn */ "v"])(key)) {
                            // ignore v-model handlers when they fail to fallthrough
                            if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isModelListener */ "t"])(key)) {
...
function triggerEvent(vnode, name) {
    ...
    if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isFunction */ "o"])(eventListener)) {
        eventListener();
    }
}
...
function traverse(value, seen = new Set()) {
    if (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isObject */ "u"])(value) || value["__v_skip" /* SKIP */]) {
        return value;
    }
    seen = seen || new Set();
    if (seen.has(value)) {
    ...
    const load = () => {
        ...
        return (pendingRequest ||
            (thisRequest = pendingRequest = loader()
                ...
                if (( true) && comp && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isObject */ "u"])(comp) && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isFunction */ "o"])(comp)) {
...
function applyOptions(instance) {
    ...
    if (dataOptions) {
        ...
        if (( true) && Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isPromise */ "x"])(data)) {
...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
    ...
    if (hasAttrsChanged) {
        Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* trigger */ "u"])(instance, "set" /* SET */, '$attrs');
    }
    if ((true)) {
        validateProps(rawProps || {}, props, instance);
    }
...
function normalizePropsOptions(comp, appContext, asMixin = false) {
    ...
    if (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isArray */ "n"])(raw)) {
        for (let i = 0; i < raw.length; i++) {
            if (( true) && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isString */ "C"])(raw[i])) {
        ...
        if (( true) && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isObject */ "u"])(raw)) {
                ...
                if (forcePatchValue ||
                    ...
                    for (const key in props) {
                        if ((forcePatchValue && key.endsWith('value')) ||
                            (Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isOn */ "v"])(key) && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isReservedProp */ "y"])(key))) {
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
    ...
    const cloned = {
        ...
        children: ( true) && patchFlag === -1 /* HOISTED */ && Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isArray */ "n"])(children)
...
function toHandlers(obj) {
    const ret = {};
    if (( true) && !Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isObject */ "u"])(obj)) {
...
const PublicInstanceProxyHandlers = {
    get({ _: instance }, key) {
        ...
        if (publicGetter) {
            if (key === '$attrs') {
                Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* track */ "t"])(instance, "get" /* GET */, key);
        ...
        ((globalProperties = appContext.config.globalProperties),
            ...
            (!Object(_vue_shared__WEBPACK_IMPORTED_MODULE_1__[/* isString */ "C"])(key) ||
...
function setupStatefulComponent(instance, isSSR) {
    ...
    instance.proxy = Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* markRaw */ "g"])(new Proxy(instance.ctx, PublicInstanceProxyHandlers));
    if ((true)) {
...
function getExposeProxy(instance) {
    if (instance.exposed) {
        return (instance.exposeProxy ||
            (instance.exposeProxy = new Proxy(Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* proxyRefs */ "i"])(Object(_vue_reactivity__WEBPACK_IMPORTED_MODULE_0__[/* markRaw */ "g"])(instance.exposed)), {
                get(target, key) {
                    if (key in target) {
                        return target[key];
                    }
